...
export const PetsOrderContextProvider = (props) => {
    ...
    const initalizePets = (petsFromApi) => {
        setPets(petsFromApi);
    }
    ...
    return (<PetsOrderContext.Provider
     value={{order: order, addPetToOrder: addPetToOrder, removePetFromOrder: removePetFromOrder, pets: pets, initalizePets: initalizePets }}
    >
        {props.children}
